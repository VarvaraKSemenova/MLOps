...
n_days = transaction_list.select('TX_TIME_DAYS').rdd.max()[0]
n_compr_terminals = 2
n_compr_customers = 2
...
# Geterate situations when customer is compromised
transaction_list = transaction_list.withColumn(
    'TX_AMOUNT',
